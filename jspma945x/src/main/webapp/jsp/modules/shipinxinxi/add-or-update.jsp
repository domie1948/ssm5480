...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>视频简介</label>
										<textarea name="shipinjianjie" class="form-control" id="shipinjianjie" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>发布日期</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#shipinjianjie").val(ruleForm.shipinjianjie);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					$("#shipinjianjie").val(res.data.shipinjianjie);
					}
