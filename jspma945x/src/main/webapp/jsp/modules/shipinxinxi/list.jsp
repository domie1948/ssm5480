	...
	<script>
		...
		function setDataRow(item,number){
			...
			var shipinjianjieCell  = document.createElement('td');
						  ...
						  if(item.shipinjianjie != null && item.shipinjianjie != "" && item.shipinjianjie.length >= 11){
			  	shipinjianjieCell.innerHTML = item.shipinjianjie.substring(0, 10) + "..."; 
			  }else{
			  	shipinjianjieCell.innerHTML = item.shipinjianjie;
			  }
